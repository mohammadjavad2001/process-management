...
public class nonp_priority {
    ...
    public void findavgTime(ArrayList<ProcessClass> list, ArrayList<ProcessClass> queue) {
        ...
        for (int j = 0; j < 1000; j++) {
            ...
            nonp_priority Executer = new nonp_priority();
            temp = Executer.nonpriorityExecuter(queue, wt, Response, temp[0], temp[1]);

            nonppriorityfindTurnAroundTime(queue, wt, tat);
    ...
    static int[] nonpriorityExecuter(ArrayList<ProcessClass> queue, int wt[], int Response[], int t, int utiliz) {
    ...
    static void nonppriorityfindTurnAroundTime(ArrayList<ProcessClass> queue, int wt[], int tat[]) {
